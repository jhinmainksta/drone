...
Нажимаем “Войти”. Переходим в ***/home/pi/catkin_ws/src/drone/drone/camera_info/*** и копируем туда калибровочный .yaml файл:
...
Войдем под логином ***pi*** и паролем ***raspberry***, перейдем в директорию ***/home/pi/catkin_ws/src/drone/drone/launch*** и начнем редактировать конфигурацию ***main_camera.launch***:
