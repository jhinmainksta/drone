...
4. Для Клевера 4 выберите подтипа рамы *COEX Drone 4*. В ином случае – *Generic Quadrotor X*.
...
> **Info** Использование типа рамы *COEX Drone 4* не требует ввода коэффициентов PID.
